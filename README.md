...
> current `22.0.0-alpha.6` version may introduce breaking API, styling, and behavior changes before
...
```json
{
  "mcpServers": {
    "aeris": {
      "command": "npx",
      "args": ["-y", "@aeris-ui/mcp@22.0.0-alpha.6"]
    }
  }
}
```
...
```bash
ng add @aeris-ui/core@22.0.0-alpha.6
```
