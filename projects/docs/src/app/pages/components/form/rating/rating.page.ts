...
export class RatingPage {
  ...
  protected readonly importCode = `import { AerisRating } from '@aeris-ui/core/rating';`;
...
interface RatingIconContext {
  ...
  protected readonly inputs: readonly ApiRow[] = [
    {
      ...
      type: 'number (model)',
      defaultValue: '0',
      description: 'Numeric rating value with two-way binding support.',
    },
    { name: 'max', type: 'number', defaultValue: '5', description: 'Number of rating items.' },
    {
      ...
      type: 'boolean',
      defaultValue: 'false',
      description: 'Allows half-step values.',
    },
    {
      name: 'allowClear',
      type: 'boolean',
      defaultValue: 'true',
      description:
        'Allows setting the rating to zero with repeat click, Home, Delete, Backspace, clear(), or reset().',
    },
    {
      name: 'disabled',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'boolean',
      defaultValue: 'false',
      description: 'Sets aria-required for validation flows.',
    },
    {
      name: 'size',
      type: 'AerisRatingSize',
      defaultValue: "'md'",
      description: "Visual star size. Options: 'xs', 'sm', 'md', 'lg'.",
    },
    {
      name: 'showValue',
      type: 'boolean',
      defaultValue: 'false',
      description: 'Shows formatted value text next to the rating.',
    },
    {
      name: 'name',
      type: 'string',
    ...
    },
    {
      ...
      description: 'ID applied to the focusable rating control.',
    },
    {
      name: 'ariaLabel',
      type: 'string',
    ...
    {
      name: 'valueText',
      type: '((value: number, max: number) => string) | null',
      defaultValue: 'null',
      description: 'Formats visible value text and aria-valuetext.',
    },
  ];
  ...
  protected readonly outputs: readonly ApiRow[] = [
    ...
    },
    {
      ...
      defaultValue: '-',
      description: 'Committed keyboard or pointer value change.',
    },
    {
      name: 'focused',
      type: 'FocusEvent',
  ...
  protected readonly methods: readonly ApiRow[] = [
    {
      ...
      type: 'void',
      defaultValue: '-',
      description: 'Focuses the rating control.',
    },
    {
      name: 'reset()',
      type: 'void',
      defaultValue: '-',
      description: 'Resets the value to zero or the minimum permitted value.',
    },
    {
      name: 'clear()',
      type: 'void',
      defaultValue: '-',
      description: 'Clears the value when allowClear is enabled.',
    },
  ];
  ...
  protected readonly templates: readonly ApiRow[] = [
    {
      name: '#activeIcon',
      type: 'TemplateRef<RatingIconContext>',
      defaultValue: 'star',
      description: 'Projected template used for selected rating items.',
    },
    {
      name: '#inactiveIcon',
      type: 'TemplateRef<RatingIconContext>',
      defaultValue: 'star',
      description: 'Projected template used for unselected rating items.',
    },
  ];

  protected readonly formatScore = (value: number, max: number): string => `${value}/${max} score`;
