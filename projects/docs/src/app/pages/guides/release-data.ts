...
export const AERIS_RELEASES: readonly AerisReleaseEntry[] = [
  ...
  },
  {
    ...
    status: 'Alpha patch',
    changes: [
      'Refine Toast severity styling, defaults, optional icons, compact sizing, stacking, and mobile safe-area placement.',
      'Restore reliable touch interaction and compact responsive sizing across Select and related dropdown controls.',
      'Prevent Dialog and Drawer backdrops from passing dismissal input through to underlying content.',
      'Normalize consumer-projected button icons and align Menubar item geometry with Aeris buttons.',
      'Delay native invalid styling until validation should be presented and sanitize malformed InputNumber editing.',
      'Make Dialog and Drawer action areas responsive on narrow screens.',
      'Automatically escape clipping boundaries while keeping floating panels anchored and viewport constrained.',
      'Harden nested Escape handling, DatePicker focus navigation, focus traps, and dynamic disabled overlays.',
      'Refresh the supported Angular 22 development toolchain and audited dependencies.',
    ],
  },
  {
