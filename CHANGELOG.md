...
- Add versioned canonical AI documentation with a JSON schema, structured corpus, focused
  component Markdown, `llms.txt`, and a self-contained `llms-full.txt` context file.
- Add the separate local `@aeris-ui/mcp` package with read-only documentation resources, focused
  search and retrieval tools, bundled version-matched documentation, and a complete setup guide.
...
## [22.0.0-alpha.0] - Alpha development prerelease
